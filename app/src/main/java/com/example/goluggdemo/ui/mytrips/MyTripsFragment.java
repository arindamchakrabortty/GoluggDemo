package com.example.goluggdemo.ui.mytrips;
...
import com.example.goluggdemo.databinding.FragmentMytripsBinding;
...
public class MyTripsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        myTripsViewModel.getText().observe(getViewLifecycleOwner(), new Observer<String>() {
            @Override
